package com.orangeHr.utilities;
...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testcontext) {
		...
		htmlReporter.config().setDocumentTitle("OrangeHR test Project"); // Title of Report
	...
	public void onTestFailure(ITestResult tr) {
		...
		if(f.exists()) {
			...
			try {
				logger.fail("Sccreenshot is below:"+ logger.addScreenCaptureFromPath(screenshotpath));
			}
